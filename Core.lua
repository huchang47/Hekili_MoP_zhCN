...
local function GetDataText()
    ...
    if AddonCompartmentFrame then
        AddonCompartmentFrame:RegisterAddon({
            ...
            notCheckable = true,            func = Hekili_OnAddonCompartmentClick,
    ...
    if LDB then
        ...
        ns.UI.Minimap:RefreshDataText()        if LDBIcon then
    ...
    checkImports()    ns.primeTooltipColors()
        ...
        while actID <= #list do
            ...
            if self:IsActionActive( packName, listName, actID ) then
                ...
                elseif rWait <= state.cooldown.global_cooldown.remains and not state.spec.can_dual_cast and ability.gcd ~= "off" then
                    ...
                    local entryReplaced = false                    if action == "trinket1" then
